...
class Matrix:
    def __init__(self, mtrx=None, function=int, name='', square=False, height=0, width=0):
        if mtrx is None:
            mtrx = in_out.input_matrix(function=function, square=square, name=name, widht=width, height=height)
        else:
